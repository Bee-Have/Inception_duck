...
# wp core install --path=/var/www --url=$URL --title=$TITLE --admin_name=$MYSQL_ADMIN_USER --admin_password=$MYSQL_ADMIN_PASSWORD --admin_email=$MYSQL_ADMIN_EMAIL --allow-root --skip-email
